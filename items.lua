	...
	PlaceObj('ModItemTutorialHint', {
		Hints = {
			PlaceObj('TutorialHintItem', {
				...
				Text = T(375361284496, --[[ModItemTutorialHint nests_awaken_tutorial Text]] "<em>1 of 6</em>\nThe Nests of this world are now <em>more complex</em>, <style TextNegative>deadly</style>, and coordinate between each other!\n\nEach species cares a lot about <em>certain activities</em> or when you <em>consume</em> certain resources.\nWhen a species hears of your un-neighborly activities, they will deploy scouts to find their new neighbors."),
			}),
			PlaceObj('TutorialHintItem', {
				Image = "Mod/TGkJ3Tu/PicsOritDidntHappen/AngryNest.PNG",
				Text = T(283738735418, --[[ModItemTutorialHint nests_awaken_tutorial Text]] "<em>2 of 6</em>\nOnce a nest is alerted to an enemy species (Including you!), a nest will become active.\nAn active nest will constantly perform one of the following actions:\n#1. Consume nearby resources.\n#2. Deploy attack waves targeting you. *If it is the closest nest of it's species to you\n#2a. Otherwise the nest will send supporting units to the next closest nest.\n#3. Deploy attack waves targeting another species nest (Based on if it is scouted).\n#4. Deploy more scouts, in an attempt to keep the entire map known to their species\n#5. Try and wake up other nests of it's own species.\n\n<style TextNegative>Nests will grow stronger the longer they are active.\nAnd should only be left alone at your own peril!</style>"),
			}),
			PlaceObj('TutorialHintItem', {
				Image = "Mod/TGkJ3Tu/PicsOritDidntHappen/nesting_icons.JPG",
				Text = T(467697453699, --[[ModItemTutorialHint nests_awaken_tutorial Text]] "<em>3 of 6</em>\n\nBecause this mod is introducing new unit behaviors, helper icons show above units that behave differently.\nThe distance you need to zoom in to see the icons are adjustable via a mod-option.\nThe following icons, from left to right, mean:\n- The unit is guarding a nearby nest\n- The unit is going to a nearby friendly nest, and on arrival will grant a boon to said nest\n- The unit is scouting a specific part of the map, looking for it's species enemies\n- The unit is scouting, and has found you!\n\nNote <em>if</em> you manage to stop these units before they arrive at their nest, that will stifle that species ability to grow stronger!"),
			}),
			PlaceObj('TutorialHintItem', {
...
PlaceObj('ModItemFolder', {
	'name', "Nesting Species",
	'NameColor', RGBA(204, 88, 12, 255),
}, {
...
PlaceObj('ModItemHealthCondition', {
	...
	Coughing = true,
	Description = T(661142601070, --[[ModItemHealthCondition glutch_fumes Description]] "The local air quality has made it really hard to breath, sleep, and work...\nIt all started when those weird trees bloomed....."),
